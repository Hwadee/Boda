    ...
    <div class="wrapper">
        <form id="form1" action="LoanInfo.do">
            <div class="searchWidget">
                <input type="text" name="loanMinDate" id="loanMinDate" placeholder="最早贷款时间" class="datepicker"
                       style="width: 45%" value="${loanMinDate}"/>
                <input type="text" name="loanMaxDate" id="loanMaxDate" placeholder="最晚贷款时间" class="datepicker"
                       style="width: 45%" value="${loanMaxDate}"/>
