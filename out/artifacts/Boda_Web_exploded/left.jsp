...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        <li class="dash"><a href="index.jsp" title="" class="active"><span>首页</span></a></li>
        <li class="charts"><a href="#" title="" class="exp"><span>系统设置</span></a>
            <ul class="sub">
                <li><a href="部门管理.jsp" title="">部门管理</a></li>
        ...
        <li class="forms"><a href="#" title="" class="exp"><span>贷前账户管理</span></a>
            <ul class="sub">
                <li><a href="客户信息录入.jsp" title="">客户信息录入</a></li>
        ...
        <li class="ui"><a href="#" title="" class="exp"><span>贷后账户管理</span></a>
            <ul class="sub">
                ...
                <li class="last"><a href="逾期情况报表.jsp" title="">逾期情况报表</a></li>
            </ul>
        </li>
