                    ...
                    <tr>
                        ...
                        <td>
                            <form id="form2" action="savaDistributeMessage.do" method="POST">
                                <input type="hidden" id="customerId" name="customerId" value="${overTimeDistribute.customerMessage.customerId}"/>
                                <div class="form">
                                <input type="text" id="customerCredit" name="customerCredit"
                                       value="${overTimeDistribute.customerMessage.customerCredit}" style="width: 50%"/>
                                </div>
                            </form>
                        </td>
                    </tr>
